...
/**
 * @Autor Autor Alexandre <asa-008@hotmail.com> & Winder Rezende <windergt@gmail.com>
 * @Data 06/06/2018
 */
public class ValidaCPF {
    ...
    public static boolean isCPF(String CPF) {
        ...
        try { // "try" - protege o codigo para eventuais erros de conversao de tipo (int) // Calculo do 1o. Digito Verificador                       
            sm = 0;
            peso = 10;
            ...
            sm = 0;
            peso = 11;
            for (i = 0; i < 10; i++) { // Calculo do 2o. Digito Verificador
                num = (int) (CPF.charAt(i) - 48);
                sm = sm + (num * peso);
                peso = peso - 1;
            }
